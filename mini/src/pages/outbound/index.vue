  ...
  <div class="pages" :class="tab_show_pages">
    ...
    <div class="pages_header">
      ...
      <div class="search_box">
        ...
        <div class="multiple_search_input" v-if="role==='boss'||role==='store'" @click="orderApply">
              ...
              <scroll-view scroll-y style="height: 100%;">
                <div class="list-item" v-for="(item,index) in purchaseOrderList" :key="index" @click="get_details(item)">
                  ...
                  <div class="item item4">
                    {{item.status_name}}
                    <icon class="iconfont iconshenhe" v-if="(role=='storage'||role=='boss')&&item.status=='apply'"></icon>
                  </div>
                </div>
              </scroll-view>
            </div>
    ...
    <LtabBar nowPath="/pages/outbound/main" key="procurement"></LtabBar>
  </div>
</template>
<script>
